package com.sinoshem.corelibrary.weidgets;
...
import com.sinoshem.corelibrary.R;
...
public class LoadFrameLayout extends FrameLayout {
    ...
    public LoadFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyText = ApiConstants.EMPTY_INFO;
        mErrorText = ApiConstants.NET_ERROR_RETRY;
    }
    ...
    public void setEmptyText(String emptyText) {
        ...
        TextView textView = ButterKnife.findById(emptyView, R.id.empty_text);
        if (textView != null) {
    ...
    public void setErrorText(String errorText) {
        ...
        TextView textView = ButterKnife.findById(errorView, R.id.error_text);
        if (textView != null) {
    ...
    // webView INVISIBLE而不是GONE
    public void bindWebView(@LoadFrameState int data) {
        if (mCurrentState == data) {
            return;
        }
        ...
        if (loadingView != null) loadingView.setVisibility(data == LOADING ? VISIBLE : GONE);
        if (contentView != null) contentView.setVisibility(data == CONTENT ? VISIBLE : INVISIBLE);
    ...
    public boolean isLoading() {
        return mCurrentState == LOADING;
    }

    public boolean isContent() {
        return mCurrentState == CONTENT;
    }
